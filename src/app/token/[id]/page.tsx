    ...
    if (foundToken) {
      ...
      const extendedToken: ExtendedToken = {
        ...
        socialLinks: {
          ...
          github: foundToken.type === 'ERC-20' ? 'https://github.com/' + foundToken.symbol.toLowerCase() + '-protocol' : undefined,
        }
      };
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="pt-16 pb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
            ...
            {/* ICO/TGE Details */}
            <div className="bg-gray-800 p-6 rounded-xl">
              <h2 className="text-xl font-semibold mb-4 border-b border-gray-700 pb-2">Token Generation Event</h2>
              <div className="space-y-4">
                {token.tgeDetails ? (
                  <>
                    <div className="flex justify-between">
          ...
          <div className="bg-gray-800 p-6 rounded-xl mb-8">
            <h2 className="text-xl font-semibold mb-4 border-b border-gray-700 pb-2">Community & Social</h2>
            {token.socialLinks ? (
              <div className="flex flex-wrap gap-4">
                ...
                <a 
                  ...
                  className="flex items-center space-x-2 bg-gray-700 hover:bg-gray-600 px-4 py-2 rounded-lg transition-colors"
                >
                  <svg className="w-5 h-5 text-indigo-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a 
                  ...
                  className="flex items-center space-x-2 bg-gray-700 hover:bg-gray-600 px-4 py-2 rounded-lg transition-colors"
                >
                  <svg className="w-5 h-5 text-blue-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a 
                  ...
                  className="flex items-center space-x-2 bg-gray-700 hover:bg-gray-600 px-4 py-2 rounded-lg transition-colors"
                >
                  <svg className="w-5 h-5 text-purple-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                ...
                {token.socialLinks.github && (
                  <a 
                    ...
                    className="flex items-center space-x-2 bg-gray-700 hover:bg-gray-600 px-4 py-2 rounded-lg transition-colors"
                  >
                    <svg className="w-5 h-5 text-gray-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
